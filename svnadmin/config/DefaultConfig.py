...
class DefaultConfig:
    ...
    # authn_file: a .htpasswd style password file, used for svnadmin authentication.
    ...
    # Svnadmin authentication method.
    # You can use htpasswd_login, or ldap_login, or both.
    # You can also implement your own auth module.
    #from svnadmin.model.auth.http import htpasswd_login
    #from svnadmin.model.auth.ldap_login import ldap_login
